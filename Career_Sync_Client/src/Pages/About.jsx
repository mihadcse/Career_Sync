    ...
    <div className="pt-16 bg-black/30 min-h-screen">
      <div className="text-white py-16 text-center">
        ...
        <p className="text-lg text-gray-300 mt-2 max-w-2xl mx-auto">
          We are a passionate duo of developers who built this platform to bridge
          the gap between job seekers and employees. Our mission is to make job
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            <img
              src={member.image}
              alt={member.name}
              className="w-32 h-40 rounded-full mx-auto mb-4 border-4 border-cyan-400"
            />
